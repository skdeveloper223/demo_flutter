...
class HttpUtil {
  ...
  Future<String?> refreshToken() async {
    ...
    if (response.statusCode == 200) {
      ...
      getStorageData.saveObject(getStorageData.token, response.data['data']['token']);
      ...
      case DioErrorType.badResponse:
        {
          try {
            ...
            switch (errCode) {
              ...
              default:
                return ErrorEntity(code: errCode, message: error.response != null ? error.response!.data!['ResponseMsg'] : "");
            }
