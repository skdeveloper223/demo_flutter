...
/*  Future getAddressFromLatLng() async {
    ...
    final url = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=${Constants.googleApiKey}';
  ...
  /* Future<BitmapDescriptor> convertNetworkImageToCustomBitmapDescriptor(String imageUrl,
      {int size = 150,
  ...
  // =-=-=-=-=-=-=-=-=- Create DynamicLink 👇 =-=-==-=-=->>>>>>
/*
  Future<String> createDynamicLink(bool short, String userType, String bookingId) async {
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: "https://adres.page.link/",
      link: Uri.parse("https://adres.page.link/$userType?id=${bookingId}"),
      androidParameters: const AndroidParameters(
        packageName: 'com.adres.app',
        minimumVersion: 1,
      ),
      iosParameters: const IOSParameters(
        bundleId: 'com.adres.app',
        minimumVersion: "1",
      ),
    );
    ...
    var linkMessage = url.toString();
    var isCreatingLink = false;

    print("Hey NORA" + linkMessage.toString());
    return url.toString();
  }*/
