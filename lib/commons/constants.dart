...
String selectedLang = '';
String fontFamilyBold = selectedLang == Constants.languageCodeAr ? 'Tajawal-Bold' : 'BentonSans-Bold';
String fontFamilyLight = selectedLang == Constants.languageCodeAr ? 'Tajawal-Light' : 'BentonSans-Light';
String fontFamilyBook = selectedLang == Constants.languageCodeAr ? 'Tajawal-Regular' : 'BentonSans-Book';
String fontFamilyRegular = selectedLang == Constants.languageCodeAr ? 'Tajawal-Regular' : 'BentonSans-Regular';
String fontFamilyMedium = selectedLang == Constants.languageCodeAr ? 'Tajawal-Medium' : 'BentonSans-Medium';
String fontFamilyMediumtext = /*selectedLang == Constants.languageCodeAr ? 'Tajawal-Medium' :*/ 'BentonSans-Medium';
...
class Constants {
  ...
  //API calling....
  static const String baseUrl = "http://kmclientapp.co.in:3030/api/";
  ...
  // static const String socketBaseUrl = "http://kmclientapp.co.in:3030/";
  ...
  static const String googleApiKey = "AIzaSyDbtrJdSBOXWcJlq8aP5iLw-2KcjVPDz0M";
  static String bold = "";
  static String light = "";
  static String book = "";
