                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icProfile,
                          height: 25.px,
                          color: controller.firstName.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icProfile,
                          height: 25.px,
                          color: controller.lastName.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          height: 25.px,
                          color: controller.email.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icPhone,
                          height: 25.px,
                          color: controller.phone.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          height: 25.px,
                          color: controller.dob.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          height: 25.px,
                          color: controller.identityNumber.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          height: 25.px,
                          color: controller.city.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      readOnly: true,
                      suffixIcon: Icon(Icons.arrow_forward_ios, color: AppColors().lightText.withOpacity(0.5)),
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icWeb,
                          height: 25.px,
                          color: controller.country.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icBuildings,
                          height: 25.px,
                          color: controller.address.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          height: 25.px,
                          color: controller.postalCode.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icStreet,
                          height: 25.px,
                          color: controller.state.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.bank,
                          height: 25.px,
                          color: controller.bankNumber.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
                    ...
                    CommonTextField(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(
                          ImagePath.icRouting,
                          height: 25.px,
                          color: controller.routingNumber.text.isNotEmpty ? AppColors().buttonColor : AppColors().buttonColor.withOpacity(0.5),
                        ),
                      ),
                      onChange: (value) {
                        controller.update();
